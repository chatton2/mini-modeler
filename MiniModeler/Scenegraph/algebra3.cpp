...
void
vec3::print(){
	std::cout << "(" << std::setprecision(3) << this[0] << ", " << this[1] << ", " << this[2] << ")" << std::endl;
	std::cout << " " << std::endl;
}
...
void
vec4::print(){
	std::cout << "(" << std::setprecision(3) << this[0] << ")" << std::endl;
	std::cout << " " << std::endl;
}
...
void
mat3::print(){
	std::cout << std::setprecision(3) << "|" << this[0][0] << " " << this[1][0] << " " << this[2][0] << "|" << std::endl;
	std::cout << std::setprecision(3) << "|" << this[0][1] << " " << this[1][1] << " " << this[2][1] << "|" << std::endl;
	std::cout << std::setprecision(3) << "|" << this[0][2] << " " << this[1][2] << " " << this[2][2] << "|" << std::endl;
	std::cout << " " << std::endl;
}
...
mat4::print(){
	std::setprecision(3);
	std::cout << std::setprecision(3) << "|" << this[0][0] << " " << this[1][0] << " " << this[2][0] << "|" << this[3][0] << std::endl;
	std::cout << std::setprecision(3) << "|" << this[0][1] << " " << this[1][1] << " " << this[2][1] << "|" << this[3][1] << std::endl;
	std::cout << std::setprecision(3) << "|" << this[0][2] << " " << this[1][2] << " " << this[2][2] << "|" << this[3][2] << std::endl;
	std::cout << std::setprecision(3) << "|" << this[0][3] << " " << this[1][3] << " " << this[2][3] << "|" << this[3][3] << std::endl;
	std::cout << " " << std::endl;
}
